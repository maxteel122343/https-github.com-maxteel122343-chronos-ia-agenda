...
const UserProfileModal: React.FC<UserProfileModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 bg-black/20 backdrop-blur-md z-[100] flex items-center justify-center p-4">
            <div className="bg-white/95 backdrop-blur-2xl border border-gray-100 rounded-[40px] w-full max-w-2xl h-[82vh] flex flex-col shadow-[0_40px_100px_rgba(0,0,0,0.15)] animate-in fade-in zoom-in-95 duration-300 overflow-hidden">

                {/* Header */}
                <div className="p-8 border-b border-gray-50 flex justify-between items-center bg-gray-50/30">
                    <div className="flex items-center gap-6">
                        <div className="w-16 h-16 bg-white border border-gray-100 rounded-[24px] flex items-center justify-center shadow-sm group-hover:shadow-md transition-all">
                            <Zap className="text-blue-500" size={28} fill="#3b82f6" fillOpacity={0.15} />
                        </div>
                        <div>
                            <h2 className="text-2xl font-black text-gray-900 tracking-tighter">PERFIL COMPORTAMENTAL</h2>
                            <p className="text-[10px] text-gray-400 font-black uppercase tracking-[0.2em] mt-1">Sincronização com IA Chronos</p>
                        </div>
                    </div>
                    <button
                        onClick={onClose}
                ...
                <div className="flex flex-1 overflow-hidden">
                    {/* Sidebar nav */}
                    <div className="w-56 bg-gray-50/50 border-r border-gray-50 p-4 flex flex-col gap-2 shrink-0">
                        {tabs.map(tab => {
                            const Icon = tab.icon;
                            ...
                            return (
                                <button
                                    ...
                                    className={`w-full flex items-center gap-3 px-4 py-4 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all ${active
                ...
                {/* Footer */}
                <div className="p-8 border-t border-gray-50 bg-gray-50/30 flex justify-between items-center group">
                    <div className="flex items-center gap-3">
                    ...
                    <button
                        onClick={onClose}
                        className="px-10 py-4 bg-blue-600 hover:bg-blue-700 text-white text-xs font-black uppercase tracking-[0.2em] rounded-2xl transition-all shadow-xl shadow-blue-500/20 active:scale-95"
                    >
                        Salvar Perfil
                    </button>
                </div>
