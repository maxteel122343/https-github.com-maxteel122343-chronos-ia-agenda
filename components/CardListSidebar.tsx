...
const CardListSidebar: React.FC<CardListSidebarProps> = ({
    ...
    return (
        <div className="fixed inset-y-0 right-0 w-[400px] z-[2000] bg-white/90 backdrop-blur-2xl border-l border-gray-100 shadow-[-20px_0_60px_rgba(0,0,0,0.05)] flex flex-col animate-in slide-in-from-right duration-500 ease-out">
            {/* Header */}
